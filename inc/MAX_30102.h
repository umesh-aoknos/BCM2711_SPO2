...
#define MAX30102_I2C_ADDR_WRITE  0xAE  // 8-bit write address
#define MAX30102_REG_INT_STATUS1 0x00
#define MAX30102_REG_INT_STATUS2 0x01
#define MAX30102_REG_INT_ENABLE1 0x02
#define MAX30102_REG_INT_ENABLE2 0x03
...
typedef enum {
    REG_NOERROR = 0,
    REG_FIFO_WR_PTR_READ_ERROR = -1,
    REG_FIFO_WR_PTR_WRITE_ERROR = -2,
    REG_FIFO_RD_PTR_READ_ERROR = -3,
    REG_FIFO_RD_PTR_WRITE_ERROR = -4,
    REG_FIFO_DATA_READ_ERROR = -5,
    REG_FIFO_DATA_WRITE_ERROR = -6,
    REG_PART_ID_READ_ERROR = -7,
    PART_ID_ERROR = -8,
    REG_MODE_CONFIG_READ_ERROR = -9,
    REG_MODE_CONFIG_WRITE_ERROR = -10,
    REG_FIFO_CONFIG_READ_ERROR = -11,
    REG_FIFO_CONFIG_WRITE_ERROR = -12,
    REG_SPO2_CONFIG_READ_ERROR = -13,
    REG_SPO2_CONFIG_WRITE_ERROR = -14,
    REG_LED1_PA_READ_ERROR = -15,
    REG_LED1_PA_WRITE_ERROR = -16,
    REG_LED2_PA_READ_ERROR = -17,
    REG_LED2_PA_WRITE_ERROR = -18,
    REG_MULTI_LED_CTRL1_READ_ERROR = -19,
    REG_MULTI_LED_CTRL1_WRITE_ERROR = -20,
    REG_MULTI_LED_CTRL2_READ_ERROR = -21,
    REG_MULTI_LED_CTRL2_WRITE_ERROR = -22,
    REG_OVF_COUNTER_READ_ERROR = -23,
    REG_OVF_COUNTER_WRITE_ERROR = -24,
    REG_TEMP_CONFIG_READ_ERROR = -25,
    REG_TEMP_CONFIG_WRITE_ERROR = -26,
    REG_TEMP_INT_READ_ERROR = -27,
    REG_TEMP_INT_WRITE_ERROR = -28,
    REG_TEMP_FRAC_READ_ERROR = -29,
    REG_TEMP_FRAC_WRITE_ERROR = -30,
    REG_INT_STATUS1_READ_ERROR = -31,
    REG_INT_STATUS1_WRITE_ERROR = -32,
    REG_INT_STATUS2_READ_ERROR = -33,
    REG_INT_STATUS2_WRITE_ERROR = -34,
    REG_INT_ENABLE1_SETBITS_ERROR = -35,
    REG_INT_ENABLE1_CLRBITS_ERROR = -36,
    REG_INT_ENABLE2_SETBITS_ERROR = -37,
    REG_INT_ENABLE2_CLRBITS_ERROR = -38,
    NULL_PTR_ERROR = -50,
